...
class CDatabase(object):
    def __init__(self, config_filename):
        ...
        try:
            self.o_conn = cloudant.Cloudant(
                o_config.get("DATABASE", "USERNAME"),
    ...
    def new_image_ref(self, tw_id: str, tw_username: str,
        ...
        mime, dec_data = dict_image_b64dec(enc_data)
        ...
        o_image.save(
            os.path.join(o_config.get("SITE", "image_ref"), hex_hash + ".jpeg",
                         "JPG"))
